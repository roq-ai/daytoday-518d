...
function BusinessListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BusinessInterface[]>(
    ...
    () =>
      getBusinesses({
        relations: ['user', 'analytics.count', 'product.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('analytics', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>analytics</Th>}
